...
export default class DragSortableView extends Component{
    ...
    startTouch(touchIndex) {
        ...
        this.props.onDragStart().then(() => {
            this.onDragStartResolved = true;
            // this.sortParentRef.measure((x, y, width, height, pageX, pageY) => {
            //     this.parentPageY = pageY;
            // })
        });
    ...
    moveTouch (evt, gestureState) {
        ...
        if (this.onDragStartResolved) {
            if (!this.startDY) {
                this.startDY = gestureState.dy;
            } 
        } else {
            this.startDY = null;
            return;
    ...
    endTouch (nativeEvent) {
        this.onDragStartResolved = false;
        this.startDY = null;
            ...
            return (
                <Animated.View
                    ...
                    <TouchableOpacity
                        ...
                        onPressIn={()=>this.startTouch(index)}
